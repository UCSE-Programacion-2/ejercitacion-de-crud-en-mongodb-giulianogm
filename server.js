...
app.post('/equipos', async (req, res) => {
    ...
    if (!equipo || !tecnico || !continente || campeonatos_mundiales === undefined ||
        typeof equipo !== 'string' || typeof tecnico !== 'string' || 
        typeof continente !== 'string' || typeof campeonatos_mundiales !== 'number') {
    ...
    try {
        ...
        res.status(201).json({ _id: result.insertedId, ...nuevoEquipo });
    } catch (error) {
